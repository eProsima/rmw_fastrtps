  ...
  auto creator_fun = [&ros_type_support]() -> type_support_ptr
    {
      if (using_introspection_c_typesupport(ros_type_support->typesupport_identifier)) {
        auto members = static_cast<const rosidl_typesupport_introspection_c__ServiceMembers *>(
          ros_type_support->data);
        return new RequestTypeSupport_c(members, ros_type_support, ros_type_support->request_typesupport);
      } else if (using_introspection_cpp_typesupport(ros_type_support->typesupport_identifier)) {
        auto members = static_cast<const rosidl_typesupport_introspection_cpp::ServiceMembers *>(
          ros_type_support->data);
        return new RequestTypeSupport_cpp(members, ros_type_support, ros_type_support->request_typesupport);
      }
      RMW_SET_ERROR_MSG("Unknown typesupport identifier");
      return nullptr;
    };
  ...
  auto creator_fun = [&ros_type_support]() -> type_support_ptr
    {
      if (using_introspection_c_typesupport(ros_type_support->typesupport_identifier)) {
        auto members = static_cast<const rosidl_typesupport_introspection_c__ServiceMembers *>(
          ros_type_support->data);
        return new ResponseTypeSupport_c(members, ros_type_support, ros_type_support->response_typesupport);
      } else if (using_introspection_cpp_typesupport(ros_type_support->typesupport_identifier)) {
        auto members = static_cast<const rosidl_typesupport_introspection_cpp::ServiceMembers *>(
          ros_type_support->data);
        return new ResponseTypeSupport_cpp(members, ros_type_support, ros_type_support->response_typesupport);
      }
      RMW_SET_ERROR_MSG("Unknown typesupport identifier");
      return nullptr;
    };
